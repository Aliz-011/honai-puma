...
export const TableData = () => {
    ...
    const { data: revenues, isLoading: isLoadingRevenue } = useGetRevenueSAPrabayar({ date: selectedDate })
    ...
    if (!revenues) {
        return (
            <TableNotFound date={selectedDate} daysBehind={3} tableName='Revenue SA Prabayar' />
        )
    }

    const handleDownload = () => {
        exportToExcel(revenues, 'Revenue SA Prabayar', selectedDate, compactDate)
    }
    ...
    return (
        <div className="w-full overflow-x-auto remove-scrollbar">
            <ComponentCard title='Revenue SA Prabayar' desc={<button

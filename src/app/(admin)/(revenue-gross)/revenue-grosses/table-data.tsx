...
import { subMonths, intlFormat, subDays, subYears, format, endOfMonth, getDaysInMonth } from "date-fns";
...
export const TableData = () => {
    ...
    if (!revenues) {
        return <TableNotFound date={selectedDate} daysBehind={2} tableName='Revenue Gross All' />
    }

    const handleDownload = () => {
        exportToExcel(revenues, 'Revenue Gross All', selectedDate, compactDate)
    }
    ...
    return (
        <div className="w-fit overflow-x-auto remove-scrollbar">
            <ComponentCard title='Revenue Gross All' desc={<button

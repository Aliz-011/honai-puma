...
export const TableData = () => {
    ...
    const handleDownload = () => {
        exportToExcel(revenues, 'Trx SA All', selectedDate, compactDate)
    }
    ...
    return (
        <div className="w-fit overflow-x-auto remove-scrollbar">
            <ComponentCard title='Trx SA All' desc={<button
                    ...
                    <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                        <TableRow>
                            <TableCell
                                rowSpan={2}
                                isHeader
                                className="px-1.5 font-medium border-r dark:border-gray-700 text-white text-center text-theme-sm bg-rose-500"
                            >
                                Territory
                            </TableCell>
                            <TableCell
                                colSpan={11}
                                isHeader
                                className="px-1.5 font-medium border dark:bg-gray-900 text-gray-500 text-center text-theme-sm dark:text-white dark:border-gray-800"
                            >
                                Trx SA All
                            </TableCell>
                        </TableRow>
                        ...
                        {filteredRevenues.map((revenue, regionalIndex) => (
                            <React.Fragment key={regionalIndex}>
                                <TableRow>
                                    ...
                                    <TableCell className="px-1 py-0.5 border-r last:border-r-0 text-end text-theme-xs dark:text-white dark:border-gray-800">
                                ...
                                {/* BRANCH */}
                                <TableRow>
                                    <TableCell colSpan={13} className="px-1 py-2 border-r last:border-r-0 text-start font-semibold bg-gray-50 dark:text-white dark:border-gray-800 dark:bg-white/[0.03] text-theme-sm">
                                        Branch
                                    </TableCell>
                                </TableRow>

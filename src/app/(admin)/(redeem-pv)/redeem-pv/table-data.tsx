...
export const TableData = () => {
    ...
    const { data: revenues, isLoading: isLoadingRevenue } = useGetRedeemPV({ date: selectedDate })
    ...
    if (!revenues) {
        return <TableNotFound date={selectedDate} daysBehind={3} tableName='Revenue Redeem PV All' />
    }

    const handleDownload = () => {
        exportToExcel(revenues, 'Revenue Redeem PV All', selectedDate, compactDate)
    }
    ...
    return (
        <div className="w-full overflow-x-auto remove-scrollbar">
            <ComponentCard title='Revenue Redeem PV All' desc={<button

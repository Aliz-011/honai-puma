...
export const TableData = () => {
    ...
    const { data: revenues, isLoading: isLoadingRevenue } = useGetNewSales({ date: selectedDate, branch: selectedBranch, subbranch: selectedSubbranch, cluster: selectedCluster, kabupaten: selectedKabupaten })
    ...
    if (!revenues) {
        return <TableNotFound daysBehind={2} date={selectedDate} />
    }

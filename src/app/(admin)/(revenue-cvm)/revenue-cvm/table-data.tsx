...
export const TableData = () => {
    ...
    if (isLoadingRevenue) {
        return (
            <div className="max-w-[1400px] overflow-x-auto remove-scrollbar">
    ...
    if (!revenues) {
        return <TableNotFound date={selectedDate} daysBehind={3} tableName='Revenue CVM' />
    }

    const handleDownload = () => {
        exportToExcel(revenues, 'Revenue CVM All', selectedDate, compactDate)
    }
    ...
    return (
        <div className="w-fit overflow-x-auto remove-scrollbar">
            <ComponentCard title='Revenue CVM All' desc={<button
                    ...
                    <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
                        <TableRow>
                            ...
                            <TableCell
                                colSpan={11}
                                isHeader
                                className="px-1.5 font-medium border bg-blue-600 text-gray-50 text-center text-theme-sm dark:text-white dark:border-gray-800"
                            >
                                Revenue CVM All
                            </TableCell>
                        </TableRow>

     ...
     END
            ...
            .where(and(
                ...
                and(
                    ...
                    between(currRevSA.trxDate, firstDayOfCurrMonth, lastDayOfCurrMonth)
                )
            ))
     ...
     END
            ...
            .where(and(
                ...
                and(
                    ...
                    between(prevMonthRevSA.trxDate, firstDayOfPrevMonth, lastDayOfPrevMonth)
                )
            ))
            .groupBy(sql`1,2,3,4,5`)
            .as('sq2')
     ...
     END
            ...
            .where(and(
                ...
                and(
                    ...
                    between(prevYearCurrMonthRevSA.trxDate, firstDayOfPrevYearCurrMonth, lastDayOfPrevYearCurrMonth)
                )
            ))
            .groupBy(sql`1,2,3,4,5`)
            .as('sq2')
